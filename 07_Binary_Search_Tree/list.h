...
{ 
    ...
    flag_t        flag;            // flag for right sub tree is visited
...
flag_t get_flag_status(p_dcll_node_t node, flag_t* flag_status);
...
static p_dcll_node_t list_get_node(list_data_t data);
